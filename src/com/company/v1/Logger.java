...
import static com.company.v1.Runner.BATCH_COUNT;
import static com.company.v1.Runner.BATCH_SIZE;

public class Logger {

    private static final boolean VERBOSE = true;

    public static void header(String msg, String target, String replacement) {
        var border = "---------------------------------------------------";
        System.out.printf("%s\n%s\n%s\n", border, msg, border);
